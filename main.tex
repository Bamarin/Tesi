...
\thesistitle{Compiuter Grafica nella realizzazione di contenuti d'animazione 3D} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\degree{Ingegneria e Scienze Informatiche} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
...
\university{\href{https://unibo.it}{ALMA MATER STUDIORUM\\Università di Bologna\\Campus di Cesena}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
\group{\href{}{Laboratorio del...}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname

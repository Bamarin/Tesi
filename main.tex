...
\university{\href{https://unibo.it}{ALMA MATER STUDIORUM - Università di Bologna}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
\vspace*{.06\textheight}
{\scshape\Large \univname\\\campname\par}\vspace{1.5cm} % University name

...
\vspace*{.06\textheight}
{\scshape\large \MakeUppercase{\univname}\\\campname\par}\vspace{1.5cm} % University name
...
Questa tesi vuole mostrare il processo di produzione di un cortometraggio.
%\section{Perché (un cotometraggio)?}
La scelta di un cortometraggio deriva da
- cortometraggio piuttosto che videogioco
- uras: storia


%\section{methodology.. come?}
\ldots tecniche che mirano a semplificare il lavoro dell'animatore\ldots
...
\ldots da un punto di vista progettuale\ldots

\ldots scelte di design\ldots
...
\textbf{FK} & \textbf{F}orward \textbf{K}inematiks \\
\textbf{IK} & \textbf{I}nverse \textbf{K}inematiks \\
